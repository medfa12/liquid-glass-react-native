// Generated by portable/gen_params.py from SPIR-V reflection.
// std140 offsets are exact. Do not reorder or hand-edit.

export const PARAM_BYTES = 672;
export const PARAM_FLOATS = 168;
...
export interface GlassParams {
  ...
  pressLight: number;
  pressLightRadius: number;
  dragVec: [number, number];
  dragStretch: number;
...
export const OFFSETS: Record<string, number> = {
  ...
  saturation: 584,
  tintAmount: 588,
  reduceTransparency: 592,
  pressScale: 596,
  tintColor: 608,
  pressGlint: 620,
  pressPoint: 624,
  pressLight: 632,
  pressLightRadius: 636,
  dragVec: 640,
  dragStretch: 648,
  edgeLineOpacity: 652,
  edgeLineWidth: 656,
...
export function packParams(p: GlassParams, out: Float32Array): Float32Array {
  ...
  out[146] = p.saturation;
  out[147] = p.tintAmount;
  out[148] = p.reduceTransparency;
  out[149] = p.pressScale;
  out[152] = p.tintColor[0];
  out[153] = p.tintColor[1];
  out[154] = p.tintColor[2];
  out[155] = p.pressGlint;
  out[156] = p.pressPoint[0];
  out[157] = p.pressPoint[1];
  out[158] = p.pressLight;
  out[159] = p.pressLightRadius;
  out[160] = p.dragVec[0];
  out[161] = p.dragVec[1];
  out[162] = p.dragStretch;
  out[163] = p.edgeLineOpacity;
  out[164] = p.edgeLineWidth;
  return out;
}
